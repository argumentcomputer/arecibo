...
/// KZG commitment key
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Abomonation)]
...
where
  E::GE: PairingGroup,
{
  #[abomonate_with([u64; 12])] // this is a hack; we just assume the size of the element.
  G: G1<E>,
  #[abomonate_with([u64; 24])] // this is a hack; we just assume the size of the element.
  H: G2<E>,
  #[abomonate_with([u64; 24])] // this is a hack; we just assume the size of the element.
  tau_H: G2<E>,
}
